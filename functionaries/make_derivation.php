...
$derivar=pg_query($db,"INSERT INTO derivation (cod_program,run_student,run_functionary,criteria,derivation_status,datetime_derivated,comment)values(204,'$run_student','$run_functionary','$criteriosEncodeados',0,'$date','$comment')");
