...
<body>
  ...
  <form action="functionaries/functionary_distinction.php" method="post">
	...
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">RUN</label>
		<input type="text" id="loginEmail" maxlength="254" name="run" oninput="checkRut(this)" required>
		<p class="helper helper1">XXXXXXXX-X</p>
	</div>
